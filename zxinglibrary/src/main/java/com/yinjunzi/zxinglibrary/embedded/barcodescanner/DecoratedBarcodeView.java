...
import com.yinjunzi.zxinglibrary.embedded.zxing.client.android.DecodeFormatManager;
import com.yinjunzi.zxinglibrary.embedded.zxing.client.android.DecodeHintManager;
import com.yinjunzi.zxinglibrary.embedded.zxing.client.android.Intents;
import com.yinjunzi.zxinglibrary.view.ScanBoxView;
...
public class DecoratedBarcodeView extends FrameLayout {
    ...
    private ScanBoxView viewFinder;
...
//            }
    ...
    private void initialize(AttributeSet attrs) {
        ...
        viewFinder = (ScanBoxView) findViewById(R.id.zxing_viewfinder_view);
        viewFinder.initCustomAttrs(getContext(), attrs);
        if (viewFinder == null) {
            throw new IllegalArgumentException(
    ...
    public ScanBoxView getViewFinder() {
        return viewFinder;
    }
